...
export default function ShabariTribalShelterSchemePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setSection(yojanaJson.yojana.shabariAdivasiGharkul);
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-32">
          <div className="text-center">
            ...
            <p className="text-gray-600">शबरी आदिवासी घरकुल योजनेची माहिती उपलब्ध नाही.</p>
          </div>
        </div>
        <Footer />
      </div>
