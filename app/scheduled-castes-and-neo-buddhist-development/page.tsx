...
export default function ScheduledCastesNeoBuddhistDevelopmentPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setSection(yojanaJson.yojana.scheduledCastesNeoBuddhist);
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-32">
          <div className="text-center">
            ...
            <p className="text-gray-600">अनुसूचीत जाती व नवबौध्द विकास संबंधित माहिती उपलब्ध नाही.</p>
          </div>
        </div>
        <Footer />
      </div>
