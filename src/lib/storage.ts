...
const defaultContentStore: ContentData = {
  preheader: '<p>ग्रामपंचायत पांगरखेडा, जालना | आपण हा फॉर्म भरून आपली तक्रार किंवा सूचना आपल्या ग्रामपंचायत ला कळवू शकता | gp.jalna@gmail.com | +91-9730746355</p>',
  ...
  about: '<div class="about-section"><h2>आमची पदाधिकारी</h2><p>ग्रामपंचायत पांगरखेडा, जालना: पदाधिकारी वाटणीची गाथा</p><div class="officials-info"><p>ग्रामपंचायत हडप गाव हे जालना तालुक्यातील जिल्हा जालना येथे वसले आहे. ग्रामपंचायत जालना जिल्ह्यात हडप गाव हे जालना तालुक्यातील गावांपैकी एक आहे. ग्रामपंचायत हडप गावातील जनता हे मुख्यतः शेती व्यवसायावर अवलंबून आहे.</p><p>या गावात पोस्ट ऑफिस ग्रामपंचायत आहे हे गाव पालघर रेल्वे स्टेशन जवळ आहे आणि प्रभावशाली व्यक्ती 04 आहे ग्रामपंचायत एकूण जनसंख्या सुमारे 2460 हे ग्रामपंचायत आमची लोकसंख्या 561 आहे एकूण देवस्थानांची संख्या कुटुंबांची एकूण संख्या 563 महिला व 367 पुरुष 196 आहे एवढी आहे -06 वी पास 353 ते 10 वर -01 एसएसी ते 43 इंटर घरात दुकानांची संख्या जा व एकूण कर्मचारी संख्या -05</p></div></div>',
  yashodatha: '<div class="yashodatha-section"><h2>यशोदाथा योजना</h2><p>ग्रामपंचायत पांगरखेडा येथील यशोदाथा योजनेची माहिती</p><p>या योजनेअंतर्गत गावातील महिलांसाठी विविध सुविधा उपलब्ध करून देण्यात आल्या आहेत.</p></div>',
  header: [
    {
      id: '1',
      title: 'होम',
  ...
  homepage: `
    <div class="space-y-8">
      <div class="text-center">
        <h1 class="text-4xl font-bold text-green-800 mb-4">ग्रामपंचायत पांगरखेडा, जालना</h1>
...
const defaultFooterData: FooterData = {
  ...
  address: {
    lines: 'यू. पो. पांगरखेडा, ता: जालना, जि: जालना, पिन: 423401',
    phone: '+91-9730746355',
...
export const resetContent = (): ContentData => {
  const resetContent = {
    ...
    homepage: '<h1>ग्रामपंचायत पांगरखेडा, जालना</h1><p>आपल्या गावाची प्रगती, आपली जबाबदारी</p>',
    administrativeStructureHeading: 'प्रशासकीय संरचना',
    administrativeStructureImage: '',
    administrativeStructureMembers: [],
    officeBearers: [],
